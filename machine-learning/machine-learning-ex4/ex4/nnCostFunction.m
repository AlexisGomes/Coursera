...
D_accumulator1 = zeros(size(Theta1));
D_accumulator2 = zeros(size(Theta2));
...
for i=1:m
	...
	D_accumulator1 = D_accumulator1 + delta2(2:end)' * a1_bias;
	D_accumulator2 = D_accumulator2 + delta3' * a2_bias;

endfor

Theta1_grad = D_accumulator1 / m;
Theta2_grad = D_accumulator2 / m;
